...
sleep(3)
os.system(f"xdg-open https://youtube.com/channel/UCXAkZEub6gmfQPqsSnEqIkw")
if "linux" in sys.platform.lower():
	os.system(
			"clear"
	)
...
link_yt = "https://youtube.com/channel/UCXAkZEub6gmfQPqsSnEqIkw"
...
\033[1;37m██║░░██║██║░░██║██║░░░░░██║███████╗██████╔╝
 ...
 {white}[▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬]{white}
 {white}[{green}1{white}] {white}Mulai Spam {green}[Unlimited]
"""
...
class Main:
	...
	def main(self):
		...
		if sanz == "1" or sanz == "01":
			print(f"\n     {red}[>] {white}Contoh Nomor{red}: {yellow}+6281234567xxx")
			sleep(0.5)
			nomor = input(f"     {red}[>] {white}Nomor Target  {red}: {white}").replace("+62","")
			print(f" {white}[▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
			sleep(2.1)
			sleep(1)
			if nomor == "":
